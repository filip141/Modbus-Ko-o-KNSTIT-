  ...
  76                     ; 34 	GPIO_DeInit(GPIOD);
  78  0001 ae500f        	ldw	x,#20495
  79  0004 cd0000        	call	_GPIO_DeInit
  81                     ; 35 	GPIO_Init(GPIOD, GPIO_PIN_0, GPIO_MODE_OUT_PP_LOW_FAST);
